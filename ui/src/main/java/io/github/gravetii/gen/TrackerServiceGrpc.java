...
public final class TrackerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<
      ...
      getSearchMethod;
  private static volatile io.grpc.MethodDescriptor<
          io.github.gravetii.gen.Diztl.DisconnectReq, io.github.gravetii.gen.Diztl.DisconnectResp>
      getDisconnectMethod;
          ...
          TrackerServiceGrpc.getRegisterMethod =
              getRegisterMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setFullMethodName(generateFullMethodName("TrackerService", "Register"))
          ...
          TrackerServiceGrpc.getSearchMethod =
              getSearchMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setFullMethodName(generateFullMethodName("TrackerService", "Search"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getDisconnectMethod = TrackerServiceGrpc.getDisconnectMethod) == null) {
      synchronized (TrackerServiceGrpc.class) {
        if ((getDisconnectMethod = TrackerServiceGrpc.getDisconnectMethod) == null) {
          TrackerServiceGrpc.getDisconnectMethod =
              getDisconnectMethod =
                  io.grpc.MethodDescriptor
                      .<io.github.gravetii.gen.Diztl.DisconnectReq,
                          ...
                          newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(generateFullMethodName("TrackerService", "Disconnect"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
              ...
              asyncUnaryCall(
                  new MethodHandlers<
                      io.github.gravetii.gen.Diztl.DisconnectReq,
                      io.github.gravetii.gen.Diztl.DisconnectResp>(this, METHODID_DISCONNECT)))
          .build();
    }
  }
  ...
  public static final class TrackerServiceBlockingStub
    ...
    /** */
    public io.github.gravetii.gen.Diztl.DisconnectResp disconnect(
        io.github.gravetii.gen.Diztl.DisconnectReq request) {
      return blockingUnaryCall(getChannel(), getDisconnectMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class TrackerServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            io.github.gravetii.gen.Diztl.DisconnectResp>
        disconnect(io.github.gravetii.gen.Diztl.DisconnectReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_DISCONNECT:
          serviceImpl.disconnect(
              (io.github.gravetii.gen.Diztl.DisconnectReq) request,
              (io.grpc.stub.StreamObserver<io.github.gravetii.gen.Diztl.DisconnectResp>)
                  responseObserver);
          break;
        default:
