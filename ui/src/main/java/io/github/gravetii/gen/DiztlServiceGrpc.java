...
public final class DiztlServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<
          io.github.gravetii.gen.Diztl.GetTrackerReq, io.github.gravetii.gen.Diztl.GetTrackerResp>
      getGetTrackerMethod;
  private static volatile io.grpc.MethodDescriptor<
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getGetTrackerMethod = DiztlServiceGrpc.getGetTrackerMethod) == null) {
      synchronized (DiztlServiceGrpc.class) {
        if ((getGetTrackerMethod = DiztlServiceGrpc.getGetTrackerMethod) == null) {
          DiztlServiceGrpc.getGetTrackerMethod =
              getGetTrackerMethod =
                  io.grpc.MethodDescriptor
                      .<io.github.gravetii.gen.Diztl.GetTrackerReq,
                          ...
                          newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(generateFullMethodName("DiztlService", "GetTracker"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getUpdateTrackerMethod = DiztlServiceGrpc.getUpdateTrackerMethod) == null) {
      synchronized (DiztlServiceGrpc.class) {
        if ((getUpdateTrackerMethod = DiztlServiceGrpc.getUpdateTrackerMethod) == null) {
          DiztlServiceGrpc.getUpdateTrackerMethod =
              getUpdateTrackerMethod =
                  io.grpc.MethodDescriptor
                      .<io.github.gravetii.gen.Diztl.UpdateTrackerReq,
                          io.github.gravetii.gen.Diztl.UpdateTrackerResp>
                          newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(generateFullMethodName("DiztlService", "UpdateTracker"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                      ...
                      .setSchemaDescriptor(
                          new DiztlServiceMethodDescriptorSupplier("UpdateTracker"))
                      .build();
        }
      }
    }
  ...
  public abstract static class DiztlServiceImplBase implements io.grpc.BindableService {
    ...
    public void updateTracker(
        ...
        io.grpc.stub.StreamObserver<io.github.gravetii.gen.Diztl.UpdateTrackerResp>
            responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
              ...
              asyncUnaryCall(
                  new MethodHandlers<
                      io.github.gravetii.gen.Diztl.GetTrackerReq,
                      io.github.gravetii.gen.Diztl.GetTrackerResp>(this, METHODID_GET_TRACKER)))
          .addMethod(
              getUpdateTrackerMethod(),
              asyncUnaryCall(
                  new MethodHandlers<
  ...
  public static final class DiztlServiceStub extends io.grpc.stub.AbstractStub<DiztlServiceStub> {
    ...
    public void updateTracker(
        ...
        io.grpc.stub.StreamObserver<io.github.gravetii.gen.Diztl.UpdateTrackerResp>
            responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getUpdateTrackerMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  ...
  public static final class DiztlServiceBlockingStub
    ...
    /** */
    public io.github.gravetii.gen.Diztl.GetTrackerResp getTracker(
        io.github.gravetii.gen.Diztl.GetTrackerReq request) {
      return blockingUnaryCall(getChannel(), getGetTrackerMethod(), getCallOptions(), request);
    }

    /** */
    public io.github.gravetii.gen.Diztl.UpdateTrackerResp updateTracker(
        io.github.gravetii.gen.Diztl.UpdateTrackerReq request) {
      return blockingUnaryCall(getChannel(), getUpdateTrackerMethod(), getCallOptions(), request);
    }
  ...
  public static final class DiztlServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            io.github.gravetii.gen.Diztl.GetTrackerResp>
        getTracker(io.github.gravetii.gen.Diztl.GetTrackerReq request) {
      return futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            io.github.gravetii.gen.Diztl.UpdateTrackerResp>
        updateTracker(io.github.gravetii.gen.Diztl.UpdateTrackerReq request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_TRACKER:
          serviceImpl.getTracker(
              (io.github.gravetii.gen.Diztl.GetTrackerReq) request,
              (io.grpc.stub.StreamObserver<io.github.gravetii.gen.Diztl.GetTrackerResp>)
                  responseObserver);
          break;
        case METHODID_UPDATE_TRACKER:
          serviceImpl.updateTracker(
              (io.github.gravetii.gen.Diztl.UpdateTrackerReq) request,
              (io.grpc.stub.StreamObserver<io.github.gravetii.gen.Diztl.UpdateTrackerResp>)
                  responseObserver);
          break;
